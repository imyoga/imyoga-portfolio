  ...
  return (
    <div id={props.id} className="container-about-background">
      ...
      <div className="container-about">
        ...
        <p>
          Since I took a leap and trained in modern web app development at Par Info-tech,
          I have been <span>promoted</span> to put my hands on more advanced projects, while bringing
          ambitious ideas and a <span>positive attitude</span> to every challenge.
        </p>
